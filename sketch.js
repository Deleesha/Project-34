...
function setup(){
    ...
    pendulum1 = new Pendulum(200,200,"purple");
    sling1 = new Sling(pendulum1.body,{ x: 200 , y : 200});

    pendulum2 = new Pendulum(300,200,"purple");
    sling2 = new Sling(pendulum2.body,{ x: 300 , y : 200});

    pendulum3 = new Pendulum(400,200,"purple");
    sling3 = new Sling(pendulum3.body,{ x: 400 , y : 200});

    pendulum4 = new Pendulum(500,200,"purple");
    sling4 = new Sling(pendulum4.body,{ x: 500 , y : 200});

    pendulum5 = new Pendulum(600,200,"purple");
